...
const BotName =Guntur Bos'; 
const instagram = 'rahasia- kaelMk_'; 
const aktif = 'setiap waktu';
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Guntur\n'
            + 'ORG:GunturBos;\n'
            + 'TEL;type=CELL;type=VOICE;waid=628985545323:+62 898-5545-323\n'
            + 'END:VCARD'
const
{
WAConnection,
...
//Hay gay
//create @gunturvoinzx don't delate this please
